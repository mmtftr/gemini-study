    ...
    <div className="space-y-6 animate-fadeIn">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white font-medium py-2 px-4 rounded-lg shadow-md transition duration-150 ease-in-out transform hover:scale-105"
            disabled={isLoading}
          >
      ...
      {showGenerateForm && (
        <form
          ...
          className="p-4 bg-gradient-to-r from-green-900/30 to-teal-900/30 border border-green-500/30 rounded-lg space-y-3 animate-fadeInDown"
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-3 bg-slate-700 border border-green-500/50 rounded-lg shadow-sm focus:ring-2 focus:ring-green-400 focus:border-green-400 outline-none placeholder-slate-400 text-slate-100"
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              className="flex-1 bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white font-semibold py-2.5 px-4 rounded-lg shadow-md transition duration-150"
              disabled={isLoading}
            >
      ...
      {showCreateForm && (
        <form
          ...
          className="p-4 bg-slate-700/50 rounded-lg space-y-3 animate-fadeInDown"
        >
          <div>
            <label
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              className="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-2.5 px-4 rounded-lg shadow-md transition duration-150"
              disabled={isLoading}
            >
              Create Empty Course
            </button>
        ...
        <div className="text-center py-8 px-4 bg-slate-700/30 rounded-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              ...
              className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white font-medium py-2.5 px-5 rounded-lg shadow-md transition duration-150 flex items-center justify-center"
              disabled={isLoading}
            >
              <Sparkles size={20} className="mr-2" />
          ...
          {courses.map((course) => (
            <li key={course.id}>
              ...
              >
                ...
                <ChevronRight
                  size={20}
                  className="text-slate-500 group-hover:text-purple-300 transform transition-transform group-focus:translate-x-1"
                />
              </button>
            </li>
          ))}
